...
inDirBase = '/home/disk/bob/impacts/raw/nys_profiler_2021'
siteNcDirBase = '/home/disk/bob/impacts/raw/nys_profiler_2021'
...
for file in os.listdir(inDirBase):
    print(file)

    if file.endswith('nc'):
        (base,ext) = os.path.splitext(file)
        (prefix,date,suffix) = base.split('.')
        ncFile = inDirBase+'/'+file
