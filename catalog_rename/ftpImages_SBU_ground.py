...
#localBaseDir = '/home/disk/funnel/impacts-website/archive_ncar/surface/Pluvio'
localBaseDir = '/home/disk/funnel/impacts-website/archive_ncar/surface/Parsivel'
...
for date in os.listdir(localBaseDir):
    if date.startswith('2020'):
        ...
        for filename in os.listdir(localBaseDir+'/'+date):
            #if 'Pluvio' in filename:
            if 'Parsivel' in filename:
