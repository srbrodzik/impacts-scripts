...
# MRMS_MergedZdr_19.00_20230111-150540.grib2
...
baseDir = '/home/disk/bob/impacts/raw/mrms/fillGaps/3DZdr'
    ...
    for idx,fileFull in enumerate(files_topLevel,0):
        ...
        if fdatetime > s_datetime and fdatetime < e_datetime:
            ...
            if len(files_current) == 33:
                command = 'MrmsGribIngest -v -params '+paramDir+'/MrmsGribIngest.zdr_fill -f '+dateDir+'/*'+dateTimeStr+ext
                os.system(command)
