...
for chan in os.listdir(inDirBase):
    if ( chan.startswith('Channel05') or chan.startswith('Channel06') or chan.startswith('Channel07') or chan.startswith('Channel08') or chan.startswith('Channel09') ) and os.path.isdir(inDirBase+'/'+chan):
