            ...
            for idx,urlFileName in enumerate(urlFileList,0):
                ...
                if urlFileName not in localFileList:
                    ...
                    if products[prod]['has_anal_prod']:
                        ...
                        #if debug2:
                        #    print("   has_anal_prod: forecast_hour = ", forecast_hour)
                    else:
                        if int(parts[-1]) <= 36:
                        ...
                        #if debug2:
                        #    print("   no_anal_prod: forecast_hour = ", forecast_hour)
                    ...
                    # only ftp three hourly files to catalog server
