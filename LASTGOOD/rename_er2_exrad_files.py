...
indir = '/home/disk/bob/impacts/er2/EXRAD'
outdir = '/home/disk/bob/impacts/er2/EXRAD'
prefix = 'research.er2'
...
for file in os.listdir(indir+'/'+date):
    if file.startswith('IMPACTS') and 'xfeature' in file:
        ...
        basename = basename.replace('IMPACTS_EXRAD-Nadir_L1B_Ver1_','')
