...
tempdir = '/tmp'
outdirbase = '/home/disk/bob/impacts/netcdf/mrms/3DRefl'
nalts = 33
refl_name = 'dbz_qc'
...
if file.endswith('grib2'):
    ...
    [gribFileBase,ext] = os.path.splitext(file_base)
    ...
    ncFile = tempdir+'/'+gribFileBase+'.nc'
    #gribFile = tempdir+'/'+gribFileBase+'.grib2'
    #command = 'wgrib2 '+tempdir+'/'+gribFile+' -netcdf '+ncFile
    command = 'wgrib2 '+file+' -netcdf '+ncFile
    os.system(command)
    ...
    [product,var,level,date_time] = gribFileBase.split('_')
