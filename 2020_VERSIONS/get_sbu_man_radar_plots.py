...
url_subdirs = ['CL51','MRR','PARSIVEL']
#filename format: <product>_YYYYMMDD.png
products         = ['cl51','mrrpro','parsivel']
products_catalog = ['ceil150','mrr_pro','parsivel']
file_ext = 'png'
catalogBaseDir = '/home/disk/funnel/impacts-website/archive/research/manhattan'
