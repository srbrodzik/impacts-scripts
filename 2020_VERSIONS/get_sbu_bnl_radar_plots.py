...
url_subdirs = ['CEILOMETER','LIDAR']
#filename format: <product>_YYYYMMDD.png
products         = ['ceilometer','lidar']
products_catalog = ['ceil075','dopp_lidar']
file_ext = 'png'
catalogBaseDir = '/home/disk/funnel/impacts-website/archive/research/brookhaven'
