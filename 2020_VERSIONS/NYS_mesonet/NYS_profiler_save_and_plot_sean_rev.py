...
import numpy as np 
import matplotlib 
#get_ipython().magic('matplotlib inline')  # can only use this in ipython shell
...
indir = '/home/disk/bob/impacts/bin/test/NY_MESO_Net/'
...
def plot_mwr(mwr_df,station):
    ...
    fig.suptitle(station.upper()+' Microwave Radiometer (MWR) '+ graphtimestamp_start+' - '+graphtimestamp_end,x=0.44, y = 0.92,fontsize = 24)
    axes = []
