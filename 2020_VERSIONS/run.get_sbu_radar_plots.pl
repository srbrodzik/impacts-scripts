...
$command = "python ".$binDir."/get_sbu_bnl_radar_plots.py";
system($command);

$command = "python ".$binDir."/get_sbu_man_radar_plots.py";
system($command);

$command = "python ".$binDir."/get_sbu_mobile_radar_plots.py";
system($command);

$command = "python ".$binDir."/get_sbu_radar_plots.py";
system($command);
