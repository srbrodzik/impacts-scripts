...
# MRMS_MergedReflectivityQC_19.00_20230111-150540.grib2
...
baseDir = '/home/disk/bob/impacts/raw/mrms/fillGaps/3DRefl'
...
dateList = {'20230111':{'stime':'100640','etime':'163637'}}
...
for date in dateList.keys() :
    ...
    for idx,fileFull in enumerate(files_topLevel,0):
        ...
        if fdatetime > s_datetime and fdatetime < e_datetime:
            ...
            command = 'MrmsGribIngest -v -params '+paramDir+'/MrmsGribIngest.refl_fill -f '+dateDir+'/*'+dateTimeStr+ext
            os.system(command)
