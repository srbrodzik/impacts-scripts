...
file_ext = 'gif'
tempDir = '/tmp'
catalogPrefix = 'model.WRF_GFS_SBU_12km'
...
for t in range(0,nRuns):
    ...
    # only look for files is url exists
        ...
        for prod in products:
            ...
            for file in currentModelFList:
                ...
                if len(forecast_num) == 2:
                    if prod in tmp and int(forecast_num) <= int(float(last_forecast_num)) and int(forecast_num)%3 == 0:
