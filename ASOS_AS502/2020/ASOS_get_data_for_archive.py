...
varDict = {'time':{'units':'seconds', 'long_name':'seconds since 1970-01-01'},
           ...
           'weather_cond_code_set_1':{'units':'none' ,'long_name':'current weather conditions code (WNUM)' },
           'weather_code_1':{'units':'none' ,'long_name':'current weather code derived from WNUM' },
           'weather_code_2':{'units':'none' ,'long_name':'current weather code derived from WNUM' },
           'weather_code_3':{'units':'none' ,'long_name':'current weather code derived from WNUM' }}
