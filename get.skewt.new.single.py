...
bin_dir2 = '/home/disk/monsoon/relampago/git/lrose-projects-relampago/projDir/uw/scripts'
...
for idx,idate in enumerate(dateStrList,0):
    ...
    for site in siteList:
        ...
        for hour in hourList:
	        ...
	        #command = bin_dir2+'/skewplot.py --file '+base+'.new --outpath /tmp --format UWYO'
	        os.system(command)
