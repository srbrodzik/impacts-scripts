...
#}
siteList = {'72712':{'long_name':'Caribou_ME','short_name':'CAR'}}
...
for idx,idate in enumerate(dateStrList,0):
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
        #command = 'ln -s '+catalog_base_dir+'/text_sounding/index.php '+out_dir
        #os.system(command)
    ...
    for site in siteList:
        ...
        for hour in hourList:
            ...
            #outFile_html = out_dir+'/ops.text_sounding.'+idate+hour+'00.'+siteList[site]+'.html'
            ...
            if not outFile_html in out_dir_files:
                ...
                try:
                    ...
                    print("lwp-request failed, exception: ", e)
                    continue
	            ...
	            command = binDir+'/2020_VERSIONS_MOD/skewplot.py --file '+base+'.new --outpath /tmp --format UWYO --parcel False --hodograph False'
	            os.system(command)
	            ...
	            #command = '/bin/mv /tmp/upperair.NWS_'+siteList[site]+'_sonde.'+idate+hour+'00.skewT.png '+outFile_skewt
                    #command = '/bin/mv /tmp/upperair.SkewT.'+idate+hour+'00.'+siteList[site]+'.png '+outFile_skewt
	            #os.system(command)
                    ...
                    command = binDir+'/vertical_TvsTw_sean_rev_v2.py '+outFile_html+' '+localWbPath+' '+str(max_ht)
	            os.system(command)
                    # ftp to EOL
                    ...
                    command = '/bin/rm '+base+'.txt '+base+'.new'
                    shutil.move(localSkewtPath,
                                out_dir+'/'+outFile_skewt)
                    shutil.move(localWbPath,
                                out_dir+'/'+outFile_wetbulb)
