...
url_subdirs = ['PLUVIO','MRRWHITE']
#products         = ['mwr','pluvio','roger','solartracker']
products         = ['pluvio','mrrprowhite']
file_ext = 'png'
localDirBase = '/home/disk/bob/impacts/radar/sbu_images'
catFilePrefix = ['surface','radar']
#catPlatform = ['mwr','pluvio','roger','solar_tracker']
catPlatform = ['Pluvio','MRR']
catProduct = ['Stonybrook_NY','Stonybrook_NY_time_ht']

# FC Naming Conventions
# surface.Pluvio.202002290000.Stonybrook_NY.png
# radar.MRR.202002290000.Stonybrook_NY_time_ht.png
...
if debug:
    print('{} {}'.format('nowDateStr = ', nowDateStr))
...
if debug:
    print('{} {}'.format('startDateStr = ', startDateStr))
...
if debug:
    print('{} {}'.format('dateStrList = ', dateStrList))
...
for idate in range(0,nDates):
    ...
    for iprod in range(0,len(products)):
        if debug:
            print('{} {} {} {} {}'.format('Processing', currentDate, 'for', products[iprod], 'data'))
        ...
        url = base_url+'/'+url_subdirs[iprod]+'/'+currentYear+'/'+urlFile
        ...
        if os.path.isfile(catName):
            ...
            try:
                ...
                print('{} {}'.format('    wget failed, exception: ', e))
                continue
