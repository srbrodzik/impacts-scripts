...
last_forecast_num = 48
wrfUrl = 'http://itpa.somas.stonybrook.edu/sbuwrf'
targetDirBase = '/home/disk/bob/impacts/model/wrf_gfs_12km'
...
catalogBaseDir = '/home/disk/funnel/impacts-website/archive/model/wrf_gfs_12km'
catalogFilePrefix = 'model.wrf_gfs_12km'
    ...
    for i in range(0,len(products)):
        ...
        for file in currentModelFList:
            ...
            if len(forecast_num) == 2:
                if products[i] in tmp and int(forecast_num) <= int(last_forecast_num) and int(forecast_num)%3 == 0:
