...
gribDir = '/home/disk/bob/impacts/raw/mrms/fillGaps/2DReflComp'
filePrefix = 'MRMS_MergedReflectivityComposite'
extension = 'grib2'
...
for gribFile in os.listdir(gribDir):
    ...
    command = 'ncrename -h -v MergedReflectivityComposite_500mabovemeansealevel,'+ncVarName+' '+ncFile+' '+ncFileNew
    os.system(command)
